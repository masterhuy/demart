    ...
    $.fn.instagram = function (options) {
        ...
        function createPhotoElement(photo) {
            ...
            innerHtml
                ...
                .append('<div class="info-block">' + '<i class="fa fa-instagram"></i>' + '<span class="number-likes fa fa-heart-o">' + photo.likes.count +'</span>' + '<span class="number-comments fa fa-comments-o"><i class="insta_heart"></i> ' + photo.comments.count +'</span>' + '</div>');
