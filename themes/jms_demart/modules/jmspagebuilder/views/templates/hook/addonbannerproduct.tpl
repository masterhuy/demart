...
<div class="row">
	{if $banner_img1}
		<div class="banner-1 col-lg-3 col-md-6 col-xs-12">
			...
			<div class="banner-content">
				...
				{/if}
				{if $banner_link1}
					<a class="button" href="{$banner_link1 nofilter}">
						{l s='SHOP NOW' d='Modules.JmsPagebuilder'}! 
	...
	{/if}
	<div class="product-box col-lg-9 col-md-6 col-xs-12">
		<div 
			class="banner-product-carousel owl-carousel" 
		...
		{if $banner_img2}
			<div class="banner-2">
				...
				<div class="banner-content">
					...
					{/if}
					{if $banner_link2}
						<a class="button" href="{$banner_link2 nofilter}">
							{l s='SHOP NOW' d='Modules.JmsPagebuilder'}! 
							<span class="fa fa-long-arrow-right"></span>
						</a>
					{/if}
