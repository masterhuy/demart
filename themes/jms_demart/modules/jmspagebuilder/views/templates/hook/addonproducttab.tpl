...
<div class="addon-producttab">
	...
	<div class="tabs-navigation-mobile">
		...
		<ul class="dropdown-menu">
			{$cf = 0}
			{if $config.show_featured eq '1'}
				<li class="nav-item"><a data-toggle="tab" href="#featured" class="active">{l s='Featured Products' d='Modules.JmsPagebuilder'}</a></li>
			{$cf = $cf + 1}
			{/if}
			{if $config.show_new eq '1'}
				<li class="nav-item"><a data-toggle="tab" href="#latest" class="{if $cf eq 0} active{/if}">{l s='New Arrivals' d='Modules.JmsPagebuilder'}</a></li>
				{$cf = $cf + 1}
			{/if}
			{if $config.show_topseller eq '1'}
				<li class="nav-item"><a data-toggle="tab" href="#topseller" class="{if $cf eq 0} active{/if}">{l s='Best Seller' d='Modules.JmsPagebuilder'}</a></li>
				{$cf = $cf + 1}
			{/if}
			{if $config.show_special eq '1'}
				<li class="nav-item"><a data-toggle="tab" href="#special" class="{if $cf eq 0} active{/if}">{l s='Special' d='Modules.JmsPagebuilder'}</a></li>
				{$cf = $cf + 1}
			{/if}
			{if $config.show_onsale eq '1'}
				<li class="nav-item"><a data-toggle="tab" href="#onsale" class="{if $cf eq 0} active{/if}">{l s='On Sale' d='Modules.JmsPagebuilder'}</a></li>
				{$cf = $cf + 1}
			{/if}
		</ul>
  	</div>
