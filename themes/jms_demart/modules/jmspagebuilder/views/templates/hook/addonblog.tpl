			...
			<div class="blog-item">
				...
				{if $show_category == '1'}
					<div class="post-category">
						<span>{l s='In' d='Modules.JmsPagebuilder'}</span>
						<a href="{jmsblog::getPageLink('jmsblog-category', $catparams)|escape:'htmlall':'UTF-8'|replace:'&amp;':'&'}">{$post.category_name nofilter}</a>
					</div>
				{/if}
				<h4 class="post-title">
				...
				{if $show_readmore == '1'}
					<a class="btn btn-default post-readmore" href="{jmsblog::getPageLink('jmsblog-post', $params)|escape:'htmlall':'UTF-8'|replace:'&amp;':'&'}">
