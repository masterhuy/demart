...
{block name='footer-social'}
    <ul id="social-links" class="social-links">
        ...
        {if isset($jmsSetting.social_gplus) && $jmsSetting.social_gplus != ''}<li class="google-plus"><a href="{$jmsSetting.social_gplus}" target="_blank"><i class="fa fa-google" ></i></a></li>{/if}
