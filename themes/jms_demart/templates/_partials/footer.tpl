...
{block name="footer"}
  ...
  {else}
       {assign var='footer_layout' value=$jmsSetting.footer_layout}
  {/if}
 <footer id="footer" class="footer-{$footer_layout} {if $jmsSetting.footer_class} {$jmsSetting.footer_class}{/if}">
     {if $footer_layout == 1}
