...
<link rel="stylesheet" type="text/css" href="{$urls.theme_assets}linearicons/style.css" />
<link rel="stylesheet" type="text/css" href="{$urls.theme_assets}css/pro.min.css" />
