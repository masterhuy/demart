 ...
 *}
 ...
 {else}
      {assign var='header_layout' value=$jmsSetting.header_layout}
 {/if}
<div id="desktop-header" class="header-{$header_layout} {if $jmsSetting.header_class} {$jmsSetting.header_class}{/if}">
    {if $header_layout == 1}
