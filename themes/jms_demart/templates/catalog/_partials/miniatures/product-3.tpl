	...
	<div class="product-preview">
		{block name='product_thumbnail'}
		  	<a href="{$product.url}" class="product-image{if $jmsSetting.productbox_hover == 'swap-image' && isset($product.images.1) && $product.images.1} swap-image{else} blur-image{/if}">
                ...
                {if $jmsSetting.productbox_wishlist}
                    ...
                    {/if}
                    <a href="#" class="addToWishlist btn-icon" title="{l s='Add to Wislist' d='Shop.Theme.Actions'}" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|escape:'html'}', false, 1); return false;" data-id-product="{$product.id_product|escape:'html'}">
        ...
        <div class="product-buttons">
            ...
            {if $jmsSetting.productbox_quickview}
                <a href="#" data-link-action="quickview" title="{l s='Quick View' d='Shop.Theme.Actions'}" class="btn btn-default quick-view">{l s='Quick View' d='Shop.Theme.Actions'}</a>
            {/if}
        </div>
	</div>
	...
	<div class="product-info">
        ...
        <ul class="product-buttons">
            ...
            {if $jmsSetting.productbox_wishlist}
                ...
                {/if}
                <li>
                    <a href="#" class="addToWishlist" title="{l s='Add to Wislist' d='Shop.Theme.Actions'}" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|escape:'html'}', false, 1); return false;" data-id-product="{$product.id_product|escape:'html'}">
