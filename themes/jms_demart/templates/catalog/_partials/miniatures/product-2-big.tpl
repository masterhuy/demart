        ...
        <div class="product-buttons">
            <ul>
                ...
                {if $jmsSetting.productbox_wishlist}
                    ...
                    {/if}
                    <li>
                        <a href="#" class="addToWishlist product-btn" title="{l s='Add to Wislist' d='Shop.Theme.Actions'}" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|escape:'html'}', false, 1); return false;" data-id-product="{$product.id_product|escape:'html'}">
