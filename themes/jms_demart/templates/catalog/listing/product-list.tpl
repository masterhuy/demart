...
{else}
    {assign var='shop_list' value=$jmsSetting.shop_list}
{/if}
...
{else}
    {assign var='shop_grid_column' value=$jmsSetting.shop_grid_column}
{/if}
{extends file=$layout}
{block name='content'}
    <section id="main">
        ...
        <section id="products">
            {if $listing.products|count}
                ...
                {if $jmsSetting.shop_activefilter == 1}
                    ...
                    {/block}
                {/if}
                <div id="product_list" class="{$shop_grid_column}-grid product_list {if $shop_list == 'grid'}products-grid grid-{$shop_grid_column}{else}products-list{/if}">
