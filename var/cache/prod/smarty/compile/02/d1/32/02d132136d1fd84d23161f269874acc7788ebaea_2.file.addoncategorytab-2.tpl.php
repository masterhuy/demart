<?php
/* Smarty version 3.1.33, created on 2020-05-18 07:57:54
  from 'D:\xamppp\htdocs\jms_demart\themes\jms_demart\modules\jmspagebuilder\views\templates\hook\addoncategorytab-2.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5ec231f259a2c8_62447755',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '02d132136d1fd84d23161f269874acc7788ebaea' => 
    array (
      0 => 'D:\\xamppp\\htdocs\\jms_demart\\themes\\jms_demart\\modules\\jmspagebuilder\\views\\templates\\hook\\addoncategorytab-2.tpl',
      1 => 1589767356,
      2 => 'file',
    ),
  ),
...
function content_5ec231f259a2c8_62447755 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="addon-tab">
...
?>
				<li class="nav-item">
					<a data-toggle="tab" class="categorytab-<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['category']->value['id_category'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
 nav-link<?php if ($_smarty_tpl->tpl_vars['k']->value == 0) {?> active<?php }?>" href="#categorytab-<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['category']->value['id_category'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
">
						<span>
...
foreach ($_from as $_smarty_tpl->tpl_vars['k']->value => $_smarty_tpl->tpl_vars['category']->value) {
?>
		<div role="tabpanel" class="tab-pane<?php if ($_smarty_tpl->tpl_vars['k']->value == 0) {?> active<?php }?>" id="categorytab-<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['category']->value['id_category'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
">
			<div class="categorytab-carousel-2" data-items="<?php if ($_smarty_tpl->tpl_vars['cols']->value) {
