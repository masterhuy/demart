<?php
/* Smarty version 3.1.33, created on 2020-06-10 11:23:53
...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5ee0b4b9002f56_07267101',
...
function content_5ee0b4b9002f56_07267101 (Smarty_Internal_Template $_smarty_tpl) {
...
echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['items_show_lg']->value,'htmlall','UTF-8' )), ENT_QUOTES, 'UTF-8');
} else { ?>4<?php }?>" 
...
" class="img-responsive" />
				...
				<?php if ($_smarty_tpl->tpl_vars['show_category']->value == '1') {?>
					<div class="post-category">
						<span><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'In','d'=>'Modules.JmsPagebuilder'),$_smarty_tpl ) );?>
</span>
...
"><?php echo $_smarty_tpl->tpl_vars['post']->value['title'];?>
 ...
 view<?php if ($_smarty_tpl->tpl_vars['post']->value['views'] > 1) {?>s<?php }?>
						</li>
					<?php }?>
 ...
 comment<?php if ($_smarty_tpl->tpl_vars['post']->value['comment_count'] > 1) {?>s<?php }?>
				...
				<?php if ($_smarty_tpl->tpl_vars['show_readmore']->value == '1') {?>
					<a class="btn btn-default post-readmore" href="<?php echo htmlspecialchars(smarty_modifier_replace(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( jmsblog::getPageLink('jmsblog-post',$_smarty_tpl->tpl_vars['params']->value),'htmlall','UTF-8' )),'&amp;','&'), ENT_QUOTES, 'UTF-8');?>
">
